        ...
        for follower in followers:
            follow.append(
                ...
                {'id': follower.pk,
                 ...
                 'follower_image': follower.follower.profile.image.url if follower.follower.profile.image is not None else None
                }
                )
        return follow
        ...
        for following in followings:
            follow.append(
                {'id': following.pk,
                 ...
                 'following_image': following.following.profile.image.url if following.following.profile.image is not None else None
                }
