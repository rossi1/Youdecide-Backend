...
class AnonymousVoter(models.Model):
    ...
    survey_choice_image = models.ForeignKey('SurveyChoiceImage', models.DO_NOTHING, blank=True, null=True)
    survey_choice_text = models.ForeignKey('SurveyChoiceText', models.DO_NOTHING, blank=True, null=True)
